...
class ProductAttribute(models.Model):
    ...
    class Meta:
        ordering = ('slug', )
        verbose_name = pgettext_lazy('Product attribute model',
                                     'product attribute')
        verbose_name_plural = pgettext_lazy('Product attribute model',
                                            'product attributes')
...
class ProductImage(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = pgettext_lazy('Product image model',
                                            'product images')
